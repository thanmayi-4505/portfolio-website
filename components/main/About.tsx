            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={true}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/karachi.jpeg" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                I am a Computer Science Engineering student specializing in Data Science with a strong interest in Data Analytics and Machine Learning.
                                <br /><br />
                                I enjoy working with data to find insights, patterns, and meaningful solutions. I have hands-on experience in Python, SQL, and data analysis through academic and personal projects.
                                <br /><br />
                                I have built a CNN-based project for crop disease detection and completed a frontend internship, which helped me strengthen both analytical and technical skills.
                                <br /><br />
                                I am currently focused on improving my skills in data analytics, visualization, and problem-solving to grow as a Data Analyst.
                            </h1>
                        </motion.div>
                    )}
                </InView>
